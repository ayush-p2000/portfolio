...
import { FiGithub, FiExternalLink, FiCpu, FiTerminal, FiLayers, FiActivity } from 'react-icons/fi'
...
const projects: Project[] = [
    {
        ...
        tags: ['Next.js', 'TypeScript', 'Redux', 'YouTube API', 'Tailwind CSS'],
    ...
    },
    {
        ...
        tags: ['NodeJS', 'MongoDB', 'Express', 'OAuth', 'Stripe API'],
    ...
    },
    {
        ...
        tags: ['NodeJS', 'ExpressJS', 'MongoDB', 'Socket.io', 'SPARQL', 'Bootstrap'],
...
export default function ProjectsSoftware() {
    ...
    return (
        <section id="projects" ref={sectionRef} className="min-h-screen flex flex-col justify-center pt-40 pb-24 relative overflow-hidden scroll-mt-0">
